...
export function CreateJumpPowerSolver(solverId: string): SolverAggregate {
    let jumpPowerSolver = SolverAPI.CreateSolver({
        solverName: `JumpPower_Solver_${solverId}`,
        phases: [
            {
                name: "Flat",
                algorithm: "Flat",
